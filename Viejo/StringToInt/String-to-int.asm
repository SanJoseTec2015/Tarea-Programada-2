...
Debug: db "bien"						 ; variable para la prueba
DebugLen equ $ - Debug
...
scan:
	...
	int_to_string:	
		...
		itoa_2:
			...
			mov [varIntToString], ax	; no guarda valores en el stack y
		...
		itoa_3:
			...
			mov [varIntToString+rsi],ax 			; lo guardamos en la cadena final
...
probando:								 ; print para probar hasta donde llega
	push rax
	push rdi
	push rsi
	push rdx
