...
;	S: R14 la posicion a insertar del proximo caracter
;------------------------------------------------------------------------------------------------------------
addCharIntoTheVarVariables:
	mov byte[varVariables+r13], al
	inc r13									;indice varVariables
ret
...
addDigitintoVarVariables:
	mov byte[varVariables+r13], al
jmp obtenerValor.exit
;------------------------------------------------------------------------------------------------------------
;											addIntIntoTheVar 
;
